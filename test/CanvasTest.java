...
public class CanvasTest {
  ...
  public void setUp() {
    ...
    this.rectangle1 = new Rectangle("r", 200, 80, 50, 10, 51, 153,
            255);
    ...
    this.resize = new ResizeT(oval1, 15, 20, dimension.BASE, 60,
            80);
  }
  ...
  public void testGetShapesAtFrame() {
    // Empty method because getShapesAtFrame is not yet implemented.
    assertEquals(1, 1);
  }
