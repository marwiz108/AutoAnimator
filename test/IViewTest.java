...
public class IViewTest {
  ...
  @Test (expected = OperationNotSupportedException.class)
  public void testShowSpeedControlsThrowsExceptionForText() throws OperationNotSupportedException {
  ...
  public void testGenerateTextAfterAddingShapes() throws OperationNotSupportedException {
    this.c.addShape(new Oval(
        "o", 500, 100, 60, 30, 255, 0, 0)
    );
    this.c.addShape(new Rectangle(
        "r", 200, 200, 50, 100, 0, 0, 255)
    );
  ...
  public void testGenerateTextAfterAddingShapesAndTransformations()
    ...
    this.c.addTransformation("o", new ResizeT(oval, 8, 20,
        dimension.HEIGHT, 30, 100));
    this.c.addTransformation("o", new MoveT(oval, 5, 15,
